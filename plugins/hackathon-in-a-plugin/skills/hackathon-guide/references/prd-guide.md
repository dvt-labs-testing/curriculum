...
The PRD naturally wants to expand. Your job is to be exhaustive about what's IN without letting scope grow beyond 3-4 hours.

Watch for:
- Requirements that keep spawning sub-requirements
- "While we're at it" additions
- Features the learner is excited about but that would double build time
- Vague requirements that hide enormous complexity ("social features," "real-time sync," "recommendations")

When you spot creep, name it directly: "This is growing. Is this essential for your 3-4 hours, or would you add it with more time?" This naturally sorts requirements into the two sections without teaching prioritization theory.
